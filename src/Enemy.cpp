...
std::string Enemy::GetImagePath(MovePattern pattern) {
    switch (pattern) {
        case MovePattern::STRAIGHT: return RESOURCE_DIR "/enemy/enemy_plane.png";
        case MovePattern::WAVE: return RESOURCE_DIR "/enemy/e_tank2.png";
        case MovePattern::TRACK: return RESOURCE_DIR "/enemy/enemy_plane.png";
        case MovePattern::ZIGZAG: return RESOURCE_DIR "/enemy/e_tank1.png";
        case MovePattern::RANDOM: return RESOURCE_DIR "/enemy/enemy_plane.png";
        default: return RESOURCE_DIR "/enemies/enemy_default.png"; // 預設敵機圖片
    }
}
