...
{
   var _loc1_ = _parent;
   xSpeed += 3.6 * Math.sin(_loc1_._rotation * 3.141592653589793 / 180);
   ySpeed += 3.6 * Math.cos(_loc1_._rotation * 3.141592653589793 / 180);
   xSpeed *= 0.8;
   ySpeed *= 0.8;
   _loc1_._x += xSpeed;
   _loc1_._y -= ySpeed;
...
function getdir()
{
   ...
   if(targ.xp == undefined || targ.gone == 1)
   {
      ...
      if(_currentframe > 15)
      {
         ...
         if(targ.xp < _loc1_._y && _loc1_._y - targ.xp > 100)
         {
            delete targ;
         }
         else if(targ.xp < _loc1_._y && targ.xp - _loc1_._y > 100)
         {
            delete targ;
         }
         else if(targ.yp < _loc1_._y && _loc1_._y - targ.yp > 100)
         {
            delete targ;
         }
         else if(targ.yp < _loc1_._y && targ.yp - _loc1_._y > 100)
         {
            delete targ;
         }
         else if(orota > 90 && orota < 270)
         {
            delete targ;
         }
      }
