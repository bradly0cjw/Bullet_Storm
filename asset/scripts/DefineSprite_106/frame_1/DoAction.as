this.onEnterFrame = function()
{
   var _loc1_ = _root;
   var _loc2_ = _parent;
   if(_loc1_.plane._y < _loc2_._parent._parent.yp)
   {
      _loc2_._parent._parent.rota = Math.atan((_loc2_._parent._parent.xp - _loc1_.plane._x) / (_loc1_.plane._y - _loc2_._parent._parent.yp)) * 180 / 3.141592653589793;
   }
   else
   {
      _loc2_._parent._parent.rota = Math.atan((_loc2_._parent._parent.xp - _loc1_.plane._x) / (_loc1_.plane._y - _loc2_._parent._parent.yp)) * 180 / 3.141592653589793 + 180;
   }
   if(_loc1_.pause == 0)
   {
